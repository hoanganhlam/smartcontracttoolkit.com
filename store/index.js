...
export default {
  ...
  actions: {
    async nuxtServerInit({commit}, {req}) {
      ...
      inters.push(
        this.$axios.$get('https://gist.githubusercontent.com/comficker/9803dc8419ec0a46b8046d73630fe8ac/raw/a4d14bdb7a2f2cd4a522859f0dd72762f4f397d0/chain_list.json')
      )
